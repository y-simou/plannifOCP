 ...
 */
@Entity
public class AvailabilityMachine implements Serializable {
    ...
    public AvailabilityMachine() {
    }

    public AvailabilityMachine(Machine machine, UnitOfTime unitOfTime, boolean available) {
    ...
    public boolean equals(Object object) {
        ...
        AvailabilityMachine other = (AvailabilityMachine) object;
